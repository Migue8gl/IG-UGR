...
// RUEDA
class _wheel : public _triangulos3D
{
public:
	_wheel();
	void draw(_modo modo, float r, float g, float b, float grosor);
...
// METRALLETA
class _machinegun : public _triangulos3D
{
public:
	_machinegun();
	void draw(_modo modo, float r, float g, float b, float grosor);
...
// BALAS
class _bullet : public _triangulos3D
{
public:
	_bullet();
	void draw(_modo modo, float r, float g, float b, float grosor);
...
// HOJA
class _blade : public _triangulos3D
{
public:
	_blade();
	void draw(_modo modo, float r, float g, float b, float grosor);
...
// PUERTA
class _door : public _triangulos3D
{
public:
	_door();
	void draw(_modo modo, float r, float g, float b, float grosor);
...
// HELICE
class _propeller : public _triangulos3D
{
public:
	_propeller();
	void draw(_modo modo, float r, float g, float b, float grosor);
...
// PATINES
class _skids : public _triangulos3D
{
public:
	_skids();
	void draw(_modo modo, float r, float g, float b, float grosor);
...
// HELICOPTERO
class _helicopter : public _triangulos3D
{
public:
...
public:
	...
	_textura();
	void prepara_textura(string file, GLuint *tex_id);
	void dibuja();
